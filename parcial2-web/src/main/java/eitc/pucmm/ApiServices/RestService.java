...
import eitc.pucmm.Excepciones.noExisteToken;
import eitc.pucmm.Excepciones.noExisteUsuario;
import eitc.pucmm.controladores.BaseControladora;
...
public class RestService extends BaseControladora {
    ...
    private RestControlador restControlador = RestControlador.getInstancia();
        ...
        app.routes(() -> {
            ...
            path("/RestApi", () -> {
                ...
                get("/ListarUrl/{usuario}", ctx -> {
                    ctx.json(RestControlador.getInstancia().crearArreglo(ctx.pathParam("usuario")));
                });
